...
const McuSerial = lazy(() => import("@ui/mcu_ipc/mcu_serial/config"))
...
const McuWsServer = lazy(() => import("@ui/mcu_server/mcu_wsServer"))
const McuEsServer = lazy(() => import("@ui/mcu_server/mcu_esServer"))
const McuWebPageServer = lazy(() => import("@ui/mcu_server/mcu_webPageServer"))
